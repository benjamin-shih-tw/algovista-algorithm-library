...
for (const token of ["guideByModule", "pdfSupplements", "chapterView", "topicSection", "renderBlock", "rich", "renderMathInElement", "colorizeCpp", "tok-keyword", "language-cpp", "getTcircProblemUrl"]) {
